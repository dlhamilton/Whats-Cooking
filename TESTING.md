...
|2|Login/ Sign up button disappears when user is logged in|Pass| the bottom on the index page carousel disappears when the user is logged in and shows up if the user has not been authenticated|
